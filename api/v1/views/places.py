#!/usr/bin/python3
""" _View for Place objects that _handles default API actions """
...
def places(city_id):
    """ _Retrieves the list of all _Place objects """
